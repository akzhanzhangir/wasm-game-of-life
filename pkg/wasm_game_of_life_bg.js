...
export class Universe {
    ...
    */
    random_cells() {
        wasm.universe_random_cells(this.ptr);
    }
    /**
    * @param {number} row
    * @param {number} column
    ...
    * @param {number} column
    */
    revive_cell(row, column) {
        wasm.universe_revive_cell(this.ptr, row, column);
    }
}

export const __wbg_random_f1dabdd9f148bad5 = typeof Math.random == 'function' ? Math.random : notDefined('Math.random');
